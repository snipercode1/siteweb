...
SECRET_KEY = 'django-insecure-q0$0d^gwowzj)+r774uz%7d-+2_x_rl5@*9u-a-947bhk8_&rp'
...
STATICFILES_DIRS = [
    TEMPLATES_DIR,
    os.path.join(BASE_DIR, 'proprieter','static'),
    os.path.join(BASE_DIR, 'equipements','static'),
    os.path.join(BASE_DIR, 'accounts','static'),
    os.path.join(BASE_DIR, 'dashboard','static'),
    os.path.join(BASE_DIR, 'profiles','static'),
    os.path.join(BASE_DIR, 'communes','static'),
